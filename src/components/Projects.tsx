...
const EXPERIENCE: Project[] = [
  {
    ...
    problem:
      "Developer platforms accumulate invisible failure debt. Bugs surface at integration boundaries, docs get misclassified as bugs, and architectural problems need cross-team context to even understand. Partners churn before tickets get resolved.",
    solution:
      "Sit between engineering and product. Debug issues across application, network, and data layers, then turn those findings into documentation and architecture changes that prevent the same problems from coming back.",
    stack: [
      "API Debugging",
      "TypeScript",
      "Infrastructure",
  ...
  },
  {
    ...
    problem:
      "Cross-border payments in Africa means wiring together dozens of incompatible systems. Mobile money operators, bank rails, card networks, all with different status codes, reliability, and failure modes.",
    solution:
      "Started as a Backend Engineer, grew into Lead. Built payment APIs in Go, integrated 12+ providers, shipped SDKs in Node.js and Go, and ran developer experience for 100+ business partners.",
    stack: [
      "Go",
      "PostgreSQL",
      "Redis",
...
const FOUNDING: Project[] = [
  {
    ...
    accentColor: "#8b5cf6",
    links: [
      { label: "GitHub", href: "https://github.com/debyth-inc/debyth-svm" },
    ],
  },
  {
    id: "everest",
    ...
    problem:
      "Personal finance is scattered across a bunch of apps. Banking, subscriptions, crypto, budgets, news. Nothing gives you one clear picture.",
    solution:
      "Built a financial management platform from scratch. Go backend, PostgreSQL, React frontend. Handles subscription tracking, multi-provider balance aggregation, budgeting, and alerts.",
    ...
    links: [
      {
        label: "GitHub",
        href: "https://github.com/everestafrica/everest-api",
      },
    ],
  },
  {
    ...
    period: "May 2026",
    problem:
      "Microsandbox needed a Go SDK for programmatic sandbox management — creating, configuring, and destroying isolated environments via API.",
    solution:
    ...
    stack: ["Go", "REST APIs", "SDK Development"],
    highlights: [
    ...
    metrics: [
      ...
      { label: "Type", value: "SDK" },
      { label: "Role", value: "OSS Contributor" },
    ],
    accentColor: "#6366f1",
    links: [
      {
        label: "GitHub",
        href: "https://github.com/superradcompany/microsandbox/tree/main/sdk/go",
      },
    ],
  },
];
      ...
      <div className="two-col-grid">
        ...
        <div>
          ...
          >
            ...
            <span
              style={{ width: 24, height: 1, background: "var(--line-bright)" }}
            />
          </div>
