...
Some events can't be processed automatically — the data is malformed, the provider is down for hours, or the webhook payload is from an unknown schema version. These need **human review**.
